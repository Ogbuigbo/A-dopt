...
const AboutHero: React.FC = () => {
  return (
    <section 
      ...
      style={{ backgroundImage: 'url("https://res.cloudinary.com/dpkn1ppzj/image/upload/v1735128318/PHOTO-2024-12-20-15-59-32_lsysrd.jpg")' }}  // Replace this URL with your image URL
    >
      {/* Overlay */}
